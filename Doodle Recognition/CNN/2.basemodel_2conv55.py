...
model.add(Conv2D(filters=32, kernel_size=(5, 5), activation='relu',strides=1, padding ='same',input_shape=(img_height, img_width, 1)))
model.add(Conv2D(filters=32, kernel_size=(5, 5), activation='relu',strides=1))
model.add(Flatten())
